        ...
        <>
            <div className={styles.panerEnd}>
                ...
                <div className={styles.div_paner}>
                    <img src={require('../../../assets/images/home/panerEndHome/Frame 112.png')} alt="error in img" />
                ...
                <div className={styles.div_paner}>
                    ...
                    <img src={require('../../../assets/images/home/panerEndHome/Frame 110.png')} alt="error in img" />
                </div>


                <div className={styles.div_paner}>
                    <img src={require('../../../assets/images/home/panerEndHome/Frame 111.png')} alt="error in img" />
                    <div className={styles.desc}>
